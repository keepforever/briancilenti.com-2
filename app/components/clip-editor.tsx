...
export const ClipEditor = () => {
  ...
  // State for video properties to avoid accessing refs during render
  ...
  // Update video state on time updates
  useEffect(() => {
